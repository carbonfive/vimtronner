(function() {
  ...
  CycleView = (function() {
    ...
    function CycleView(cycle, game, startX) {
      this.cycle = cycle;
      this.game = game;
      this.startX = startX;
    ...
    CycleView.prototype.render = function() {
      ...
      nextX = (this.cycle.x + this.startX) + 1;
    ...
    CycleView.prototype.generateWallViews = function() {
      ...
      return this.wallViews = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          wall = _ref[_i];
          _results.push(new WallView(wall, this.startX));
        }
        return _results;
      }).call(this);
    };
    ...
    CycleView.property('nameX', function() {
      var screenX;
      screenX = CycleView.startX + CycleView.cycle.x;
    ...
    CycleView.prototype.renderWinnerMessage = function() {
      ...
      messageX = this.startX + this.cycle.x - 1;
